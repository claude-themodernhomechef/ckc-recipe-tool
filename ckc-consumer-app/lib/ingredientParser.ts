...
const BASELINE_DB: Record<string, string> = {
  ...
  'frozen mixed peas and carrots':'frozen','frozen vegetables':'frozen','frozen mixed vegetables':'frozen',

  // ── Round 72 — shopping-category gap fill ─────────────────────────────────────
  // Proteins
  'white fish':'protein','red snapper':'protein','arctic char':'protein',
  'boneless pork chop':'protein','boneless pork chops':'protein',
  'pork spareribs':'protein','baby back ribs':'protein',
  'pork shoulder':'protein','pork loin':'protein',
  'boneless chuck':'protein','beef chuck':'protein','beef tenderloin':'protein',
  'oxtail':'protein','lamb shanks':'protein','lamb shoulder':'protein','rack of lamb':'protein',
  'whole chicken':'protein','chicken legs':'protein','chicken sausage':'protein','chicken tenders':'protein',
  'cooked salmon':'protein','smoked salmon':'protein',
  'lobster tails':'protein',
  'canned chickpeas':'protein','canned beans':'protein','canned salmon':'protein','canned tuna':'protein',
  'albacore tuna in olive oil':'protein','anchovy fillets in oil':'protein','anchovy fillets':'protein',
  'cooked chicken':'protein','cooked shredded chicken':'protein','shredded chicken':'protein',
  'jumbo shrimp':'protein','dried beans':'protein','beef stew meat':'protein','new york strip steak':'protein','skirt steak':'protein',
  // Dairy / refrigerated
  'parmigiano-reggiano':'dairy','hummus':'dairy','tzatziki':'dairy','labneh':'dairy',
  'havarti dill cheese':'dairy','gouda cheese':'dairy','pepper jack cheese':'dairy','white cheddar cheese':'dairy',
  'plain whole milk greek yogurt':'dairy','plain greek yogurt':'dairy','plain yogurt':'dairy',
  'full-fat greek yogurt':'dairy','whole milk greek yogurt':'dairy','non-dairy yogurt':'dairy','vegan yogurt':'dairy',
  'cottage cheese':'dairy','italian cheese blend':'dairy','mexican cheese blend':'dairy','shredded cheese':'dairy','mozzarella cheese':'dairy',
  'mascarpone':'dairy','non-dairy creamer':'dairy','vegan parmesan cheese':'dairy',
  // Produce
  'sprouts':'produce','rocket':'produce','crunchy onions':'pantry-consumables',
  'cherry plums':'produce','plantain':'produce','mandarin orange segments':'produce',
  'iceberg lettuce':'produce','little gem lettuce':'produce','romaine lettuce':'produce',
  'pearl onions':'produce','vidalia onion':'produce','onions':'produce',
  'fingerling potatoes':'produce','yukon gold potatoes':'produce','white potato':'produce','baby tomatoes':'produce',
  'pineapple':'produce','clementines':'produce','grapefruit':'produce','sun gold tomatoes':'produce','tomatoes-on-the-vine':'produce',
  'baby back ribs neck bones':'protein','english cucumber':'produce',
  'fresh cilantro':'produce','fresh parsley':'produce','fresh italian parsley':'produce','fresh basil':'produce','fresh dill':'produce',
  'fresh mint':'produce','fresh thyme':'produce','fresh rosemary':'produce','fresh oregano':'produce','fresh sage':'produce','fresh tarragon':'produce',
  'fresh chives':'produce','fresh ginger':'produce','fresh herbs':'produce','fresh scallions':'produce','fresh green onions':'produce',
  'lime':'produce','lemon':'produce','lemon zest':'produce','orange zest':'produce',
  'kale':'produce','collard greens':'produce','swiss chard':'produce','curly kale':'produce','baby kale':'produce',
  'pumpkin seeds':'produce','sun-dried tomatoes':'pantry-consumables','sun-dried tomatoes in oil':'pantry-consumables',
  'cabbage':'produce','red cabbage':'produce','radicchio':'produce','carrot tops':'produce','endive':'produce',
  'roasted red peppers':'pantry-consumables','roasted tomatoes':'pantry-consumables','fire roasted tomatoes':'pantry-consumables',
  // Pantry / condiments / pantry-consumables
  'noodles':'pantry-consumables','pasta':'pantry-consumables','couscous':'pantry-consumables','pastina':'pantry-consumables','basmati rice':'pantry-consumables',
  'jasmine rice':'pantry-consumables','white rice':'pantry-consumables','brown rice':'pantry-consumables','sweet rice':'pantry-consumables','thai sweet rice':'pantry-consumables','short-grain white rice':'pantry-consumables',
  'aji amarillo paste':'pantry-consumables','sherry wine':'pantry-consumables',
  'rendered lard':'pantry-consumables','marinated artichokes':'pantry-consumables',
  'ranch':'pantry-consumables','applesauce':'pantry-consumables','miracle whip':'pantry-consumables','horseradish':'pantry-consumables',
  'frijoles de olla':'protein',
  'herb flatbread':'pantry-consumables','italian bread':'pantry-consumables','whole grain bread':'pantry-consumables','whole wheat bread':'pantry-consumables','pita bread':'pantry-consumables','naan':'pantry-consumables','tortillas':'pantry-consumables','corn tortillas':'pantry-consumables','flour tortillas':'pantry-consumables','tortilla chips':'pantry-consumables','plantain chips':'pantry-consumables','taco shells':'pantry-consumables',
  'wonton strips':'pantry-consumables','phyllo dough':'pantry-consumables','puff pastry':'pantry-consumables','bread crumbs':'pantry-consumables','italian breadcrumbs':'pantry-consumables','panko breadcrumbs':'pantry-consumables',
  'nori':'pantry-consumables','seaweed':'pantry-consumables','wasabi peas':'pantry-consumables',
  'caper brine':'pantry-consumables','capers':'pantry-consumables','black olives':'pantry-consumables','castelvetrano olives':'pantry-consumables','peruvian black olives':'pantry-consumables',
  'salsa':'pantry-consumables','guacamole':'pantry-consumables','sour cream':'dairy','queso fresco':'dairy','cotija cheese':'dairy',
  'shaoxing rice wine':'pantry-consumables','rice wine vinegar':'pantry-consumables','sherry vinegar':'pantry-consumables','white vinegar':'pantry-consumables',
  'maple syrup':'pantry-consumables','molasses':'pantry-consumables','brown sugar':'pantry-consumables','light brown sugar':'pantry-consumables',
  'tahini':'pantry-consumables','garlic sauce':'pantry-consumables','sambal oelek':'pantry-consumables','chili crunch':'pantry-consumables','chili flakes':'pantry-consumables','red pepper flakes':'pantry-consumables','sichuan peppercorns':'pantry-consumables','black peppercorns':'pantry-consumables',
  'mace':'pantry-consumables','cardamom':'pantry-consumables','asafoetida':'pantry-consumables','tajin':'pantry-consumables',
  'ancho chili powder':'pantry-consumables','ranch seasoning':'pantry-consumables','italian seasoning':'pantry-consumables','poultry seasoning':'pantry-consumables','curry powder':'pantry-consumables','smoked paprika':'pantry-consumables','dehydrated minced onion':'pantry-consumables','fenugreek leaves':'pantry-consumables',
  'corn kernels':'produce','roasted corn kernels':'frozen','frozen peas':'frozen',
  'cauliflower rice':'frozen','poblano pepper':'produce','scotch bonnet pepper':'produce','serrano pepper':'produce','jalapeno':'produce',
  'mango':'produce','grass-fed ground beef':'protein','grass fed ground beef':'protein',
  'green chiles':'produce','green chili':'produce','green chilies':'produce','dried red chilies':'pantry-consumables','dried chilies':'pantry-consumables',
  'kimchi':'pantry-consumables','non-dairy yogurt':'dairy','vegan yogurt':'dairy',
  'mixed vegetables':'frozen','stir-fry vegetables':'frozen',
  'tapioca flour':'pantry-consumables','cornstarch':'pantry-consumables','all-purpose flour':'pantry-consumables',
  'thai bird chilies':'produce','dried red chinese chilies':'pantry-consumables','chipotle chile in adobo sauce':'pantry-consumables',
  'pickled red onion':'pantry-consumables','pickled jalapeno':'pantry-consumables','pickled onions':'pantry-consumables',
  'avocado':'produce','jicama':'produce','fennel seeds':'pantry-consumables',
  'beer':'pantry-consumables','dijon mustard':'pantry-consumables','mustard':'pantry-consumables','mayonnaise':'pantry-consumables','mayo':'pantry-consumables',
  'cedar planks':'pantry-consumables','bouillon cube':'pantry-consumables','vegetable broth':'pantry-consumables','chicken broth':'pantry-consumables','beef broth':'pantry-consumables','clam juice':'pantry-consumables','chickpea liquid':'pantry-consumables',
  'pistachios':'pantry-consumables','slivered almonds':'pantry-consumables','flaked almonds':'pantry-consumables','cashews':'pantry-consumables','chestnuts':'pantry-consumables','sesame seeds':'pantry-consumables',
  'shredded carrots':'produce','shredded mexican cheese blend':'dairy','vegan parmesan cheese':'dairy',
  'matchstick carrots':'produce','baby tomatoes':'produce','cherry tomatoes':'produce',
  'extra firm tofu':'protein','tofu':'protein',
  'lobster':'protein','salmon':'protein','salmon fillet':'protein','salmon fillets':'protein','tilapia':'protein',
  'sea bass':'protein','snapper':'protein','catfish':'protein','flounder':'protein','grouper':'protein','sardines':'protein',
  'extra-virgin olive oil':'pantry-consumables','olive oil':'pantry-consumables','sesame oil':'pantry-consumables','peanut oil':'pantry-consumables','avocado oil':'pantry-consumables','coconut oil':'pantry-consumables',
  'half-and-half':'dairy','milk':'dairy','heavy cream':'dairy','whole milk':'dairy','whipping cream':'dairy',
  'butter':'dairy','salted butter':'dairy','unsalted butter':'dairy',
  'parmesan cheese':'dairy','feta cheese':'dairy','goat cheese':'dairy','blue cheese':'dairy','ricotta cheese':'dairy','cheddar cheese':'dairy','monterey jack cheese':'dairy','mozzarella':'dairy',
  'hot sauce':'pantry-consumables','soy sauce':'pantry-consumables','fish sauce':'pantry-consumables','worcestershire sauce':'pantry-consumables','marinara sauce':'pantry-consumables','bbq sauce':'pantry-consumables','tamari':'pantry-consumables',
